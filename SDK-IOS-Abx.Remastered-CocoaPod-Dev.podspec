Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/IGAWorksDev/SDK-IOS-Abx.Remaster-Cocoapod-Dev'
...
You can test it before AdBrixRemasteredSDK is released
  ...
  s.source           = { :git => 'https://github.com/IGAWorksDev/SDK-IOS-Abx.Remaster-Cocoapod-Dev.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.platform = :ios
  s.ios.deployment_target = '9.0'
  s.ios.vendored_frameworks = 'AdBrixRM.xcframework'
